...
import me.yeojoy.barcodereader.R;
...
public class MyViewFinderView extends View implements IViewFinder {
    ...
    static {
        TAG = MyViewFinderView.class.getSimpleName();
    }
    ...
    public synchronized void updateFramingRect() {
        ...
        Log.d(TAG, "viewResolution : " + viewResolution.toString());
        int width;
        int height;
        ...
        Log.d(TAG, "viewResolution.x : " + viewResolution.x + ", viewResolution.y : " + viewResolution.y);
        Log.d(TAG, "width : " + width + ", height : " + height);
        Log.d(TAG, "leftOffset : " + leftOffset + ", topOffset : " + topOffset);
        Log.d(TAG, "mFramingRect : " + mFramingRect.toString());
        Log.d(TAG, "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    }
}
